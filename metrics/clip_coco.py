...
def run_test_on_dir(target_dir):
    ...
    txt_path = '/home/jovyan/konovalova/steering/all_coco_prompts.txt'

    with open(txt_path, 'r', encoding='utf-8') as f:
        prompts = [line.strip() for line in f if line.strip()]
            
    print(prompts)
    for i, filename in enumerate(image_files[:1000]):
        prompt = prompts[i]
...
#run_test_on_dir("/home/jovyan/konovalova/steering/experiments/flux_dev/remove/generated_images/coco_512_dev/500_5_mean_diff_s_one_vec_new_only_pooled_2_scaled_clip_2_512/steered")
run_test_on_dir("/home/jovyan/konovalova/steering/flux_generated_images_coco_correct_512_512_ablation_5000")
