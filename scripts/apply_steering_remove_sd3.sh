...
CUDA_VISIBLE_DEVICES=2,3, python apply_steering_with_injection_flux.py \
    ...
    --min_signal_threshold 0.05 \
    --cls_min 20.0 \
    --results_dir "experiments/flux_schnell/add/generated_images/hat/2000_15_mean_diff_s_only_pooled_eigen_pairs" \
    --inference_steps 4 \
    --seed 42 \
    --steer_txt \
    --vector_type 'diff' \
...
CUDA_VISIBLE_DEVICES=2,3, python apply_steering_with_injection_flux.py \
    ...
    --min_signal_threshold 0.05 \
    --cls_min 20.0 \
    --results_dir "experiments/flux_schnell/add/generated_images/hat/2000_15_mean_diff_m_only_pooled_eigen_pairs" \
    --inference_steps 4 \
    --seed 42 \
    --steer_txt \
    --vector_type 'diff' \
...
CUDA_VISIBLE_DEVICES=2,3, python apply_steering_with_injection_flux.py \
    ...
    --min_signal_threshold 0.05 \
    --cls_min 20.0 \
    --results_dir "experiments/flux_schnell/add/generated_images/hat/1000_15_mean_diff_m_only_pooled_eigen_pairs" \
    --inference_steps 4 \
    --seed 42 \
    --steer_txt \
    --vector_type 'diff' \
