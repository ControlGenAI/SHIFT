#!/bin/bash
# Step 3/3 (SD3.5): apply steering vectors at inference time.
# Run after scripts/steering_calculate_sd3.sh
# Run from repository root: bash scripts/apply_steering_sd3.sh
set -euo pipefail

DATA_DIR="experiments/sd35/remove/final_steering/block_steering/nudity"
RESULTS_DIR="experiments/sd35/remove/generated_images/block_diff/nudity"
PROMPTS_PATH="prompts_collection/main_experiments/ablation_prompts_remove.txt"
