...
RESULTS_DIR="${RESULTS_DIR:-/home/jovyan/konovalova/clean_code/steering/experiments/flux_schnell/test_compare_remove/generated_images_big/subspace/block/txt_block_013_txt_pooled_6_cls_coco_correct_neutral_k_1}"
