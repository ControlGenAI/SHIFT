...
NEG_PATH="${NEG_PATH:-/home/jovyan/konovalova/clean_code/steering/experiments/flux_schnell/test_compare_add/data_vector/data_vector_attn_100/glasses__gs_0.0_prompts_100_neg_attn.pt}"
POS_PATH="${POS_PATH:-/home/jovyan/konovalova/clean_code/steering/experiments/flux_schnell/test_compare_add/data_vector/data_vector_attn_100/glasses__gs_0.0_prompts_100_pos_attn.pt}"
SAVE_DIR="${SAVE_DIR:-experiments/flux_schnell/test_compare_add/final_steering/subspace_act_txt_meandiff_tokenwise_raw_delta_attn_tokenwise_T_top_meandiff_100_100_main_centered}"
